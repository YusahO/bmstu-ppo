    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaylistsAudiotracks", x => new { x.AudiotrackId, x.PlaylistId });
                    table.ForeignKey(
                        name: "FK_PlaylistsAudiotracks_Audiotracks_AudiotrackId",
                        column: x => x.AudiotrackId,
                        principalTable: "Audiotracks",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaylistsAudiotracks_Playlists_PlaylistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaylistsAudiotracks_PlaylistId",
